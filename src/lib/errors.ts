...
export const AppErrorPayloadsMap: Record<AppErrorCode, AppErrorPayload> = {
  ...
  [AppErrorCodesMap.BAD_URL]: {code: 'BAD_URL', message: 'Provided URL is not a valid one.', status: 400},
  ...
  [AppErrorCodesMap.BAD_HOSTNAME]: {code: 'BAD_HOSTNAME', message: 'Provided hostname is not allowed to be shortened.', status: 400},
};
